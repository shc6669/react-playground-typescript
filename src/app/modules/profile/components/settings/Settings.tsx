          ...
          <div className='mb-8 row'>
            ...
            <div className='col-lg-9 col-xl-6'>
              <div className='form-check form-check-custom form-check-solid mb-3'>
                ...
                />
                <label className='form-check-label fw-semibold text-gray-600' htmlFor='kt_checkbox_1'>
              ...
              <div className='form-check form-check-custom form-check-solid mb-3'>
                ...
                />
                <label className='form-check-label fw-semibold text-gray-600' htmlFor='kt_checkbox_2'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                />
                <label className='form-check-label fw-semibold text-gray-600' htmlFor='kt_checkbox_3'>
          ...
          <div className='mb-8 row'>
            ...
            <div className='col-lg-9 col-xl-6'>
              <div className='form-check form-check-custom form-check-solid mb-3'>
                ...
                />
                <label className='form-check-label fw-semibold text-gray-600' htmlFor='kt_checkbox_4'>
                  Upon new order
                </label>
              </div>
              <div className='form-check form-check-custom form-check-solid mb-3'>
                ...
                />
                <label className='form-check-label fw-semibold text-gray-600' htmlFor='kt_checkbox_5'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                />
                <label className='form-check-label fw-semibold text-gray-600' htmlFor='kt_checkbox_6'>
                  Member registration
                </label>
              </div>
            </div>
          ...
          <div className='mb-8 row'>
            ...
            <div className='col-lg-9 col-xl-6'>
              <div className='form-check form-check-custom form-check-solid mb-3'>
                ...
                />
                <label className='form-check-label fw-semibold text-gray-600' htmlFor='kt_checkbox_7'>
              ...
              <div className='form-check form-check-custom form-check-solid mb-3'>
                ...
                />
                <label className='form-check-label fw-semibold text-gray-600' htmlFor='kt_checkbox_8'>
              ...
              <div className='form-check form-check-custom form-check-solid mb-3'>
                ...
                />
                <label className='form-check-label fw-semibold text-gray-600' htmlFor='kt_checkbox_9'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                />
                <label className='form-check-label fw-semibold text-gray-600' htmlFor='kt_checkbox_10'>
